...
<div class="view view-event" id="view-event">
	
	<div class="container">
		<h1>AWESOME EVENT</h1>
		<h4>POLITIKENS HUS, RÅDHUSPLADSEN 1, 1550 COPENHAGEN K</h3>
		<div class="event-container">
			<img src="img/partners/sharkgaming.png" class="event-image">
			<div class="event-info">
				<div class="event-date-price">
					<h4 class="event-price">400 kr</h4>
					<h4 class="event-date">2. May 2017	</h4>
				</div>
				<p>
